 ...
 * montagem, então nada se perde. Quem precisa dela faz:  await window.ARAUTOS.nucleoPronto
 */
import { fingerprintOfElement, fingerprintOfText, textOfElement, normalize, SIZE } from '../core/fingerprint.js';

const A = (window.ARAUTOS = window.ARAUTOS || {});
...
document.dispatchEvent(new CustomEvent('arautos:nucleo'));
